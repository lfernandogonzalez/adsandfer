...
function open_add_mrequest() {
    document.getElementById("modal_overlay").style.display = "block";
    document.getElementById("add_mrequest_modal").style.display = "block";
    document.body.style.overflow = "hidden"; 
}

function close_add_mrequest() {
    document.getElementById("modal_overlay").style.display = "none";
    document.getElementById("add_mrequest_modal").style.display = "none";
...
function add_mrequest() {
    ...
    .then(response => {
        ...
        if (message === "Maintenance request added successfully") {
            console.log(message);
            get_mrequests();
            close_add_mrequest();  // Close the modal after successful submission
        } else {
